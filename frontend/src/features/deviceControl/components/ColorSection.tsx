      ...
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
        ...
        {!colorLocked && onResetColors && (
          ...
          >
            ...
            <Text style={{ color: "#94a3b8", fontSize: 13 }}>{t("resetColors")}</Text>
          </TouchableOpacity>
        )}
      </View>
          ...
          <>
            ...
            <Text style={styles.subLabel}>
              ...
              <Text style={styles.subValue}>
                {temperature === 0 ? t("temperatureNeutral") : temperature > 0 ? t("temperatureWarm") : t("temperatureCool")}{" "}
                ({temperature})
              </Text>
            </Text>
