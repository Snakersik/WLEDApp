...
export const deviceStyles = StyleSheet.create({
  ...
  // ===== CHOICE MODAL =====
  choiceBackdrop: { flex: 1, backgroundColor: C.bgOverlay, padding: 18, justifyContent: "center" },
  choiceCard: {
    backgroundColor: "#090916",
    borderRadius: R.xl,
    borderWidth: 1,
  ...
  choiceHeader:   { flexDirection: "row", alignItems: "flex-start", gap: 12 },
  choiceTitle:    { color: C.text, fontSize: 18, fontWeight: "900" },
  choiceSubtitle: { color: C.text2, marginTop: 6, lineHeight: 18, fontWeight: "600" },
  ...
  choicePrimaryText: { color: "#fff", fontWeight: "900", flex: 1 },
  ...
  choiceSecondaryTitle: { color: C.text, fontWeight: "900" },
  choiceSecondaryDesc:  { color: C.text2, marginTop: 2, fontSize: 12, fontWeight: "600" },
